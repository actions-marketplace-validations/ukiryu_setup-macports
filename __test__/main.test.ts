...
import type { IPlatformInfo, IMacPortsInstallInfo } from '../src/models/install-info';
...
describe('main orchestration', () => {
  ...
  beforeEach(() => {
    ...
    mockInstallInfo = {
      version: '2.11.5',
      prefix: '/opt/local',
      packageUrl: 'https://github.com/macports/macports-base/releases/download/v2.11.5/MacPorts-2.11.5-15-Sequoia-arm64.pkg',
  ...
  describe('install info structure', () => {
    it('should have complete install info', () => {
      ...
      expect(mockInstallInfo.cacheKey).toMatch(/^macports-\w+-\w+-v2-[a-f0-9]+$/);
    });
  });
